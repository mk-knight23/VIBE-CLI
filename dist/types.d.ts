...
export type IntentCategory = 'question' | 'code_generation' | 'code_assistant' | 'refactor' | 'debug' | 'testing' | 'security' | 'api' | 'ui' | 'deploy' | 'infra' | 'memory' | 'planning' | 'agent' | 'git' | 'analysis' | 'completion' | 'unknown';
